...
class StoryBrain{
  ...
  int _storyNumber = 0;
  //Change the storyNumber property into a private property so that only story_brain.dart has access to it.
  // You can do this by right clicking on the name (storyNumber) and selecting Refactor ->
